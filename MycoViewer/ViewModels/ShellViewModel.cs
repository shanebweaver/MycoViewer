...
namespace MycoViewer.ViewModels
{
    public class ShellViewModel : ViewModelBase
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(new ShellNavigationItem("Shell_MBWSearch".GetLocalized(), Symbol.Find, typeof(MBWSearchViewModel).FullName));
            _primaryItems.Add(new ShellNavigationItem("Shell_MycobankLiteratureSearch".GetLocalized(), Symbol.Find, typeof(MycobankLiteratureSearchViewModel).FullName));
