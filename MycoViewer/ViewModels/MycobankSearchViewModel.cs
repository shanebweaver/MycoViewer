...
{
    public class MycobankSearchViewModel : ViewModelBase
    {
        ...
        private ObservableCollection<MycobankTaxon> _searchResults;
        public ObservableCollection<MycobankTaxon> SearchResults
        {
            get => _searchResults;
        ...
        public MycobankSearchViewModel()
        {
            SearchCommand = new RelayCommand(Search);

            SearchFields = new ObservableCollection<string>(Enum.GetNames(typeof(MycobankSearchField)));
            ...
            SearchResults = new ObservableCollection<MycobankTaxon>();
            IsSearching = false;
        }
        ...
        private async void Search()
        {
            ...
            try
            {
                var searchField = Enum.Parse<MycobankSearchField>(_currentSearchField);
                ...
                SearchResults.Clear();
                List<MycobankTaxon> searchResults = await MycobankDataService.MycobankSearchAsync(searchField, comparisonOperator, searchValue, limit);
