...
{
    public class TaxaDescriptionsSearchViewModel : ViewModelBase
    {
        ...
        private ObservableCollection<TaxaDescriptionsTaxon> _searchResults;
        public ObservableCollection<TaxaDescriptionsTaxon> SearchResults
        {
            get => _searchResults;
        ...
        public TaxaDescriptionsSearchViewModel()
        {
            SearchCommand = new RelayCommand(Search);

            SearchFields = new ObservableCollection<string>(Enum.GetNames(typeof(TaxaDescriptionsSearchField)));
            ...
            SearchResults = new ObservableCollection<TaxaDescriptionsTaxon>();
            IsSearching = false;
        }
        ...
        private async void Search()
        {
            ...
            try
            {
                var searchField = Enum.Parse<TaxaDescriptionsSearchField>(_currentSearchField);
                ...
                SearchResults.Clear();
                List<TaxaDescriptionsTaxon> searchResults = await MycobankDataService.TaxaDescriptionsSearchAsync(searchField, comparisonOperator, searchValue, limit);
